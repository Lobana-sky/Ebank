        ...
        <div class="block-header">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> بطاقاتنا</li>
                    </ul>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            @if($card->status)
                                            <a href="javascript:void(0);" data-toggle="modal" class="btn btn-primary" data-target="#enableModal{{$card->id}}"style="background-color:#22a191" ><i class="fa fa-add" >ايقاف </i></a>
                                                @else
                                            <a href="javascript:void(0);" data-toggle="modal" class="btn btn-primary" data-target="#enableModal{{$card->id}}" style="background-color:#23b5a7a1"><i class="fa fa-add" >  تفعيل </i></a>
...
<!--------------enable -------------->
@foreach ($cards as $key => $card)
<div class="modal fade" id="enableModal{{$card->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                @if($card->status)
            ...
            <div class="modal-body"> 
              <form action="/card/{{$card->id}}/status" method="POST">
               @csrf
               <input type="hidden" name="_token" value="{{ csrf_token() }}" />
               <div class="modal-footer">
                   <button type="submit" class="btn btn-primary">نعم</button>
